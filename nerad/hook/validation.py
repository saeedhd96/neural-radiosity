...
class ValidationHook:
    def __init__(self, cfg: ValidationConfig, train_render: RenderingConfig, scene: mi.Scene, scene_path: str, integrator_injection: dict[str, Any], kwargs_injection: dict[str, Any]):
        self.cfg = cfg
        self.scene = scene
        self.use_hq = True
        ...
        self.integrator = create_integrator(self.rendering, scene, scene_path ,{"samples_per_pass": 1}, integrator_injection, kwargs_injection)
        if (self.use_hq):
            block_size = 32
